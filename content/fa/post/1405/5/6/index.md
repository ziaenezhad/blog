...
در قرن هفدهم، ایدهٔ **کاراکتریستیکای جهان‌شمول** (Characteristica Universalis) را مطرح و توصیف کرد؛ زبانی جهان‌شمول و صوری که از **نمادهای تصویری** (pictographs) بهره می‌گرفت. بعدها، مسئلهٔ **کدهای گاوس** (Gauss codes) را بررسی کرد.

در میانهٔ قرن نوزدهم، حوزهٔ **جبر بولی** (Boolean algebra) را بنیان نهاد که روشی صوری برای توصیف عملیات منطقی با استفاده از مقادیر صدق و عملگرهای مجموعه‌ای است. او در اثر خود، _پژوهشی دربارهٔ قوانین اندیشه_ (_An Investigation of The Laws of Thought_)، نشان داد که استدلال منطقی را می‌توان به صورت معادلات نمادین بیان و دست‌کاری کرد.
کوشید اندیشه‌های لایبنیتس را از طریق یک دستگاه نمادگذاری محقق سازد؛ دستگاهی که نخست در _مفهوم‌نگاری_ (_Begriffsschrift_) (۱۸۷۹) طرح شد و سپس به‌صورت کامل‌تر در کتاب دو جلدی _قوانین بنیادین حساب_ (_Grundgesetze der Arithmetik_) (۱۸۹۳/۱۹۰۳) بسط یافت. این دستگاه، «یک **زبان صوریِ زبان محض**» (formal language of pure language) را توصیف می‌کرد.

در نیمهٔ نخست قرن بیستم، چندین تحول مهم در ارتباط با زبان‌های صوری رخ داد. بین سال‌های ۱۹۰۶ تا ۱۹۱۴ چهار مقاله دربارهٔ واژه‌ها و زبان منتشر کرد. آخرین مقالهٔ او چیزی را معرفی کرد که بعدها آن را **دستگاه‌های توئه** (Thue Systems) نامید و نمونه‌ای اولیه از یک **مسئلهٔ تصمیم‌ناپذیر** (undecidable problem) ارائه داد. پست بعدها همین مقاله را مبنای اثبات خود در سال ۱۹۴۷ قرار داد که نشان می‌داد «مسئلهٔ واژه برای نیم‌گروه‌ها به‌طور بازگشتی حل‌ناپذیر است»،و سپس **دستگاه متعارف پست** (Post canonical system) را برای تولید زبان‌های صوری ابداع کرد.

در سال ۱۹۰۷، یک زبان صوری برای توصیف نقشه‌های مکانیکی (دستگاه‌های مکانیکی) معرفی کرد و آن را در مقالهٔ «دربارهٔ نظامی از نمادگذاری‌ها و علائمی برای تسهیل توصیف ماشین‌ها» (_Sobre un sistema de notaciones y símbolos destinados a facilitar la descripción de las máquinas_) منتشر ساخت. این نظام را معادل یک **زبان برنامه‌نویسی** برای کنترل عددی ماشین‌ابزارها ارزیابی کرده است.
بازنمایی انتزاعی زبان‌های صوری و زبان‌های طبیعی را ابداع کرد که امروزه با عنوان **سلسله‌مراتب چامسکی** (Chomsky hierarchy) شناخته می‌شود. در سال ۱۹۵۹، در ادامهٔ فعالیت خود در طراحی زبان برنامه‌نویسی **FORTRAN**، **صورت بکوس–نائور** (Backus–Naur Form) را برای توصیف نحو یک زبان برنامه‌نویسی سطح بالا ارائه کرد. نیز به‌عنوان دبیر و ویراستار گزارش **ALGOL 60**، از **صورت بکوس–نائور** برای توصیف بخش صوری زبان **ALGOL 60** استفاده کرد.
...
با فرض اینکه \(\Sigma\) یک مجموعهٔ ناتهی باشد، یک **زبان صوری \(L\) بر روی \(\Sigma\)**، زیرمجموعه‌ای از \(\Sigma^{_}\) است؛ که در آن \(\Sigma^{_}\) مجموعهٔ **تمام واژه‌های متناهیِ ممکن بر روی \(\Sigma\)** است. مجموعهٔ \(\Sigma\) را **الفبای \(L\)** می‌نامیم.
...
**فرانحو** (metasyntax) نحوی است که برای تعریف نحو یک **زبان برنامه‌نویسی** یا یک **زبان صوری** به کار می‌رود. فرانحو، ساختار و ترکیب مجاز عبارت‌ها و جمله‌های یک **فرازبان** (metalanguage) را توصیف می‌کند؛ فرازبانی که برای توصیف یک **زبان طبیعی** یا یک **زبان برنامه‌نویسی رایانه‌ای** مورد استفاده قرار می‌گیرد.[13]
...
نظریهٔ **تریوها** (trios) و **خانواده‌های انتزاعی زبان‌ها** (abstract families of languages) به مطالعهٔ عمومی‌ترین ویژگی‌های بستاری خانواده‌های زبان‌ها می‌پردازند.[1]
...
| ستارهٔ کلینی (Kleene star)                   | $$ L_1^{_} = \{\varepsilon\} \cup \{wz \mid w \in L_1 \land z \in L_1^{_}\} $$                        | بله            | خیر  | بله                | بله            | بله               | بله                 | بله                     |
